...
with col2:
    ...
    st.caption("Cette projection repose sur l'hypothèse d'une persistance du modèle de rigueur instauré depuis 2022, un intervalle de confiance stochastique ($23,22\%$ — $33,22\%$) permet d'anticiper les variations selon les aléas de gouvernance ou de calendrier.")
