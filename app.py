...
# Utilisation de st.write pour plus de stabilité avec le Virtual DOM
    st.write(
    f"""
    <div style="font-size: 0.85em; color: gray;">
    Cette projection repose sur l'hypothèse d'une persistance du modèle de rigueur instauré en 2022. 
    Un intervalle de confiance stochastique (23,22% — 33,22%) permet d'anticiper les variations 
    selon les aléas de gouvernance ou de calendrier.
    </div>
    """, 
