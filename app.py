...
with col2:
    ...
    st.caption("Cette projection repose sur l'hypothèse d'une persistance du modèle de rigueur instauré en 2022, un intervalle de confiance stochastique (+ ou - 05,22\%$) permet d'anticiper les variations selon les aléas de gouvernance ou de calendrier.")
